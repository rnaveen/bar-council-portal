        ...
        <div className="border-l-4 border-blue-600 bg-gray-50 dark:bg-gray-700 p-3 sm:p-4 mb-4 sm:mb-6 rounded-r">
          ...
          <table className="w-full min-w-[300px]">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                <th className="px-4 sm:px-6 py-3 text-left border-r border-gray-300 dark:border-gray-600 font-semibold text-sm sm:text-base text-gray-800 dark:text-gray-200 w-1/6">
                  S.No
                </th>
                <th className="px-4 sm:px-6 py-3 text-left border-r border-gray-300 dark:border-gray-600 font-semibold text-sm sm:text-base text-gray-800 dark:text-gray-200 w-2/3">
                  Name
                </th>
                <th className="px-4 sm:px-6 py-3 text-left font-semibold text-sm sm:text-base text-gray-800 dark:text-gray-200 w-1/6">
                  Preferential Vote
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-white dark:bg-gray-800">
                <td className="px-4 sm:px-6 py-3 sm:py-4 border-r border-gray-300 dark:border-gray-600 font-bold text-base sm:text-lg text-gray-900 dark:text-gray-100">
                  {serialNumber}
                </td>
                <td className="px-4 sm:px-6 py-3 sm:py-4 border-r border-gray-300 dark:border-gray-600 font-bold text-sm sm:text-base uppercase text-gray-900 dark:text-gray-100">
                  {name}
                </td>
                <td className="px-4 sm:px-6 py-3 sm:py-4 flex items-center">
                  <span className="font-bold text-base sm:text-lg text-gray-900 dark:text-gray-100 mr-2">ONE</span>
